...
def draw_wsn():
    ...
    for val in range(len(clst.nodes)):
        ...
        canvas.create_line(x1, y1, x2, y2, width=3, fill="yellow")  # draw line
...
app = tk.Tk()
app.title("Canvas")
wdt = app.winfo_screenwidth() * 10 / 10  # screen width segment of monitor
...
# widgetIn2.insert(tk.END, "123")  # default number of nodes
